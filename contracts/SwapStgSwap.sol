...
contract XSwap is IStargateReceiver{
    ...
    function swapThenStg(
        ...
        uint outAmount = swapAtSource(amount, route, minAmount, dstChainID, srcPoolID, dstPoolID, target, slippageStargate);

        stgSwapParams memory p = buildStgParams(
            1,
            0,
            dstChainID,
            outAmount,
